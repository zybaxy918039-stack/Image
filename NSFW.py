...
VAR2_LIST = ["掰开小穴", "抱起来做爱", "抱腿站着后入", "抱着摸小穴", "抱着躺床上", "背后坐位做爱", "传教士体位做爱", "打屁股后入", "高抬腿站着后入", "激烈站着后入", "激烈做爱", "即将插入肉棒", "口交", "口交颜射", "摸胸", "内射事后", "女上位手淫", "女上位做爱", "趴床上后入", "趴在床上", "趴着口交", "亲吻", "乳交", "射外面事后", "事后口交", "吮吸乳头", "素股", "躺着抬腿做爱", "舔小穴", "脱衣服", "一起洗澡", "站着后入", "站着足交", "指交", "抓屁股做爱", "抓着脚足交", "自己掰开小穴", "自慰", "坐着足交", "做爱高潮", "做爱射精"]
VAR3_LIST = ["1", "2", "3", "4", "5", "6"]
